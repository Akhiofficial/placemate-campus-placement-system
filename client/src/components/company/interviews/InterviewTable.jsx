...
import { Video, MoreVertical, Calendar } from 'lucide-react';
                            ...
                            <tr key={interview.id} className="hover:bg-gray-50/80 dark:hover:bg-background-muted transition-colors group bg-white dark:bg-card">
                                <td className="p-4 pl-6">
                                    <div className="flex items-center gap-3">
                                        <img src={interview.image} alt={interview.name} className="w-10 h-10 rounded-full object-cover border border-gray-100 dark:border-border" />
                                        <div>
