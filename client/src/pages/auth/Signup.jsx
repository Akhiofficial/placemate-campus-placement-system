                ...
                <div className="relative z-20 flex flex-col justify-between h-full p-12 lg:p-16 w-full">
                    ...
                    <div className="space-y-6 max-w-lg">
                        ...
                        <p className="text-lg text-blue-100/90 leading-relaxed">
                            Connect with top companies, manage your applications, and track your placement progress all in one place.
                        </p>
                        ...
                        <div className="flex items-center gap-4 pt-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-blue-200">Join 5,000+ students and recruiters.</span>
                            </div>
                        </div>
                    </div>
